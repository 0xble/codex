...
impl ChatWidget {
        ...
        match cmd {
            ...
            SlashCommand::Auto => {
                ...
                let target_mask = if self.active_mode_kind() == ModeKind::Auto {
                    ...
                    collaboration_modes::auto_mask(self.models_manager.as_ref())
                };
    ...
    fn on_entered_review_mode(&mut self, review: ReviewRequest, from_replay: bool) {
        ...
        let hint = review.user_facing_hint.unwrap_or_else(|| {
            codex_core::review_prompts::user_facing_hint(
                &review.target,
                (!review.pathspecs.is_empty()).then_some(review.pathspecs.as_slice()),
            )
        });
    ...
    fn cycle_collaboration_mode(&mut self) {
        ...
        if let Some(next_mask) =
            collaboration_modes::next_mask(self.models_manager.as_ref(), current_mask.as_ref())
        {
