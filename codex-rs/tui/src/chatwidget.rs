...
impl ChatWidget {
    ...
    fn initial_collaboration_mask(
        ...
        let requested_mode = config
            ...
            .filter(|_| config.features.enabled(Feature::CollaborationModes));
        let mut mask = match requested_mode {
